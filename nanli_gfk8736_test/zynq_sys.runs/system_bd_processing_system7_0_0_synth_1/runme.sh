...
HD_PWD='E:/PROJECT/mibus/ninli_fk/nanli_gfk8736_test/zynq_sys.runs/system_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bd_processing_system7_0_0.tcl
