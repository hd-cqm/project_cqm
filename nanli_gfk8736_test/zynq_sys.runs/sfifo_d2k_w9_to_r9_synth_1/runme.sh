...
HD_PWD='E:/PROJECT/mibus/nanli_gfk8736_he/zynq_sys.runs/sfifo_d2k_w9_to_r9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sfifo_d2k_w9_to_r9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sfifo_d2k_w9_to_r9.tcl
